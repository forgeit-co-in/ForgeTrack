  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card p-5 flex flex-col gap-5">
        ...
        <button type="submit" disabled={submitting} className="bg-brand text-white rounded-lg py-2.5 text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-60">
