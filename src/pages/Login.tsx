    ...
    <div className="min-h-screen bg-brand flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <img src="/logo.png" alt="Forgeit" className="mx-auto h-16 w-16 rounded-2xl object-cover mb-4 shadow-pop" />
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl2 shadow-pop p-6 flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-brand text-white rounded-lg py-2.5 text-sm font-medium flex items-center justify-center gap-2 hover:opacity-90 transition-colors disabled:opacity-60"
          >
